...
return [
    ...
    */
    ...
    'personal_identification' => ':attribute no es una identificación válida',
    ...
    */
    ...
    'attributes' => [
        ...
        'save'                  => 'guardar',
        'size_or_measurement'   => 'talla o tamaño',
        'state'                 => 'estado',
        'subgroup'              => 'subgrupo',
        'transfers'             => 'traslados',
        ...
        'state'                 => 'estado',
        'search'               => 'buscar',
        'confirm_save'        => '¿Confirma que desea guardar los cambios?',
